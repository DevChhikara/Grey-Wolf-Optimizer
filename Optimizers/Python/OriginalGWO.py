    ...
    for year in [2014, 2017]:
        for func_num in benchmark_dict[year]:
            ...
            for dimension in [10, 30, 50, 100]:
                func_name = f"opfunu.cec_based.F12014(ndim={dimension})"
                ...
                for pop_size in [
                    ...
                    for iter in range(1, 52):
                        ...
                        print(f"=========={model.name} => Function: {func_map_key_name}, Dimension: {dimension}, Population Size: {pop_size} :: Completed==========",
                        flush=True,
                    )
